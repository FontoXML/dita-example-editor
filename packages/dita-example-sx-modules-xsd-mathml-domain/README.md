# dita-example-sx-modules-xsd-mathml-domain
...
(`http://www.w3.org/1998/Math/MathML`) is added to the [namespaceManager](https://documentation.fontoxml.com/api/latest/namespacemanager-16319152.html) with a prefix of your choice. For an
example of the namespace declaration, please see the [dita-example-sx-integration package of the example editor](https://github.com/fontoxml/dita-example-editor/tree/develop/packages/dita-example-sx-integration).
