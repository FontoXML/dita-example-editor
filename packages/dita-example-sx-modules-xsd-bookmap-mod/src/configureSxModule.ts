...
import bookmapElementLabels from './api/bookmapElementLabels';
...
const getSubMenuForAlternativeInsertRefElement = (
	...
	subMenuLabel: uppercaseFirstLetter(
	...
	contents: [
		...
		},
		{
			contents: [
				{
					name: `:${context}-insert-${refElementName}--${placeholderOrContainer}`,
				},
			],
		},
	],
...
export default function configureSxModule(sxModule: SxModule) {
			...
			contextualOperations: [
				{
					...
					contents: [
						...
						),
						{
							...
							contents: insertTopicOperations.map(
								(operation) => ({
									name: operation,
								})
							),
	...
	configureAsRemoved(
		sxModule,
		xq`self::bookchangehistory`,
		t('book change history')
	);
	...
	configureAsFrameWithBlock(
		...
		t('book library'),
		{
			contextualOperations: [
				{
					name: ':contextual-delete-booklibrary',
	...
	configureAsSheetFrame(
		sxModule,
		xq`self::bookmap`,
		bookmapElementLabels.bookmap.markupLabel,
		{
			contextualOperations: [
				{
					contents: [
						{
							name: ':bookmap-insert-title',
							hideIn: ['structure-view'],
						},
						{
							name: ':bookmap-insert-book-title',
							hideIn: ['structure-view'],
						},
						{
	...
	configureAsFrameWithBlock(
		sxModule,
		xq`self::booktitlealt`,
		t('alternative title'),
		{
			contextualOperations: [
				{
					name: ':contextual-delete-booktitlealt',
					hideIn: ['structure-view'],
				},
			],
