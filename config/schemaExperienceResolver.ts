import SCHEMA_LOCATIONS_BASEMAP from 'dita-example-sx-shells-basemap/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_BASETOPIC from 'dita-example-sx-shells-basetopic/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_BOOKMAP from 'dita-example-sx-shells-bookmap/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_CONCEPT from 'dita-example-sx-shells-concept/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_GENERAL_TASK from 'dita-example-sx-shells-general-task/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_GLOSSGROUP from 'dita-example-sx-shells-glossgroup/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_LEARNING_ASSESSMENT from 'dita-example-sx-shells-learning-assessment/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_LEARNING_CONTENT from 'dita-example-sx-shells-learning-content/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_LEARNING_OVERVIEW from 'dita-example-sx-shells-learning-overview/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_LEARNING_PLAN from 'dita-example-sx-shells-learning-plan/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_LEARNING_SUMMARY from 'dita-example-sx-shells-learning-summary/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_MAP from 'dita-example-sx-shells-map/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_REFERENCE from 'dita-example-sx-shells-reference/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_TASK from 'dita-example-sx-shells-task/src/SCHEMA_LOCATIONS';
import SCHEMA_LOCATIONS_TOPIC from 'dita-example-sx-shells-topic/src/SCHEMA_LOCATIONS';
